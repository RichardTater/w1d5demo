...
let favTreat = "Peachy O's"
const powerLevel = 9001
let littleKidsLover = true
...
const codingLanguage = ["Python","JavaScript","Swift","c++"]
...
const codingLanguage2 = codingLanguage.slice(0,codingLanguage.length)
